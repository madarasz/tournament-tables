...
- **PHP 8.5 baseline**: New code should use modern PHP 8.x features where they improve clarity and safety
...
1. **PHP 8.5 baseline**: Runtime and tooling are aligned on modern PHP 8.x
